...
const { getUsuario, postUsuario, getUserToken, getOneUsuario } = require("../controllers/usuarios.controller");
const { getArticulos, getOneArticulo, putArticulos, deleteArticulos, getArticulosHome } = require("../controllers/articulos.controller");
...
const { cantStockDisponible, cantStockNoDisponible, cantVentas, cantUsuarios, masVendidos, menosVendidos, ultimasVentas } = require("../controllers/admin/recuentosDashboard");
const { allProductosInventario, oneProducto } = require("../controllers/admin/inventario");
const { allPedidos, onePedido } = require("../controllers/admin/pedidos");
const { postArticulos, getUltimoId, getUltimaReferencia } = require("../controllers/admin/articulos.controller");
...
//*Subir Productos
router.post("/subirimagen", upload.array('fotos', 5) , subirImagen, postArticulos);
